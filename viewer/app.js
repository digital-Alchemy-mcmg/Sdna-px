...
for(const edge of payload.graph_connection_rays||[]){const a=project(edge.source_coordinates),b=project(edge.target_coordinates);ctx.save();ctx.strokeStyle="#d1d5db55";ctx.lineWidth=1;ctx.beginPath();ctx.moveTo(a.x,a.y);ctx.lineTo(b.x,b.y);ctx.stroke();ctx.restore()}
